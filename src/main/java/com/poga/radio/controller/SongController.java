...
import com.poga.radio.domain.Song;
import com.poga.radio.service.impl.EncryptionImpl;
import com.poga.radio.service.impl.SongServiceImpl;
...
public class SongController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            ...
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("file:/home/felixcity/SpringProjects/music-admin/music-server/img/songPic");
            registry.addResourceHandler("/song/**").addResourceLocations("file:/home/felixcity/SpringProjects/music-admin/music-server/song/");
        }
    }
...
//    添加歌曲
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile) throws SodiumException {
        JSONObject jsonObject = new JSONObject();
        String singer_id = req.getParameter("singerId").trim();
        String name = req.getParameter("name").trim();
        String introduction = req.getParameter("introduction").trim();
        String pic = "/img/songPic/ic_keke.png";
         ...
         */
        String fileName = encryption.encryptFile(mpfile.getOriginalFilename());

        System.out.println(" original file name "+ mpfile.getOriginalFilename());
        System.out.println(" content type "+ mpfile.getContentType());

        System.out.println("encrypted fileName : "+ fileName);
        ...
        System.out.println(" store Path :"+ storeUrlPath);
        try {
