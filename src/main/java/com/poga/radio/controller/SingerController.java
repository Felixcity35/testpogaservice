...
import com.poga.radio.domain.Singer;
import com.poga.radio.service.impl.SingerServiceImpl;
...
public class SingerController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations("file:/home/felixcity/SpringProjects/music-admin/music-server/img/singerPic/");
        }
    }
...
//    添加歌手
    ...
    public Object addSinger(HttpServletRequest req){
        ...
        if (res){
            ...
            jsonObject.put("msg", "new singer added");
            return jsonObject;
        }else {
